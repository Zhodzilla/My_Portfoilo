...
<RadixThemesFlex align={"center"} className={"rx-Stack"} css={({ ["minHeight"] : "85vh" })} direction={"column"} justify={"center"} gap={"5"} wrap={"wrap"}>
...
<RadixThemesFlex align={"start"} className={"rx-Stack"} css={({ ["width"] : "100%", ["maxWidth"] : "600px", ["margin"] : "auto", ["overflow"] : "hidden" })} direction={"row"} justify={"center"} gap={"4"} wrap={"wrap"}>

<img css={({ ["width"] : "100%", ["hight"] : "auto" })} src={"/project_1.jpg"}/>
<img css={({ ["width"] : "100%", ["hight"] : "auto" })} src={"/project_2.jpg"}/>
<img css={({ ["width"] : "100%", ["hight"] : "auto", ["maxWidth"] : "600px", ["objectFit"] : "contain" })} src={"/project_3.jpg"}/>
</RadixThemesFlex>
</RadixThemesFlex>
</RadixThemesBox>
