...
export function Flex_2470d39e68a15af5e6178a8e784b3dd1 () {
  ...
  return (
    <RadixThemesFlex align={"center"} className={"rx-Stack"} css={({ ["minHeight"] : "85vh" })} direction={"column"} justify={"center"} gap={"5"}>
...
{(reflex___state____state__portfoilo___contact___state____contact_state.did_submit ? reflex___state____state__portfoilo___contact___state____contact_state.thank_you : "")}
...
<Root_61acdcd24990e4fd0d523bd1bae748ca/>
</Fragment>
</RadixThemesBox>
</RadixThemesBox>
...
export function Root_61acdcd24990e4fd0d523bd1bae748ca () {
  ...
  return (
    <RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_2be462a98bb2ecd2aac22957013ff984}>

<RadixThemesFlex align={"start"} className={"rx-Stack"} direction={"column"} gap={"3"}>

<RadixThemesFlex align={"start"} className={"rx-Stack"} css={({ ["width"] : "100%" })} direction={"row"} gap={"3"}>

<RadixThemesTextField.Root css={({ ["width"] : "100%" })} name={"first_name"} placeholder={"First Name"} required={true} type={"text"}/>
<RadixThemesTextField.Root css={({ ["width"] : "100%" })} name={"last_name"} placeholder={"Last Name"} type={"text"}/>
</RadixThemesFlex>
<RadixThemesTextField.Root css={({ ["width"] : "100%" })} name={"email"} placeholder={"Your email"} type={"email"}/>
<RadixThemesTextArea css={({ ["& textarea"] : null, ["width"] : "100%" })} name={"message"} placeholder={"Your name"} required={true}/>
...
<Flex_2470d39e68a15af5e6178a8e784b3dd1/>
</RadixThemesBox>
