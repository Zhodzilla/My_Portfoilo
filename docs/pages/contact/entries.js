...
import { Box as RadixThemesBox, Button as RadixThemesButton, DropdownMenu as RadixThemesDropdownMenu, Flex as RadixThemesFlex, Heading as RadixThemesHeading, IconButton as RadixThemesIconButton, Link as RadixThemesLink, Text as RadixThemesText } from "@radix-ui/themes"
...
export function Flex_79072666dfdc59bde5d82187d8b65b30 () {
  ...
  return (
    <RadixThemesFlex align={"center"} className={"rx-Stack"} css={({ ["minHeight"] : "85vh" })} direction={"column"} gap={"5"}>

<RadixThemesHeading size={"6"}>

{"Contact Entires"}
</RadixThemesHeading>
<>{ reflex___state____state__portfoilo___contact___state____contact_state.entries.map((contact, index_da61167c5e2fc214) => (
  <RadixThemesBox css={({ ["padding"] : "1em" })} key={index_da61167c5e2fc214}>
...
<Flex_79072666dfdc59bde5d82187d8b65b30/>
</RadixThemesBox>
